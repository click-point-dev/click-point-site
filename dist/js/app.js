 ...
 * @author: Jack Doyle, jack@greensock.com
*/
        var _svgPathExp = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, _scientific = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, paths_DEG2RAD = Math.PI / 180, paths_sin = (Math.PI, 
        Math.sin), paths_cos = Math.cos, _abs = Math.abs, paths_sqrt = Math.sqrt, paths_isNumber = (Math.atan2, 
        function _isNumber(value) {
            return typeof value === "number";
        }), _roundingNum = 1e5, paths_round = function _round(value) {
...
*/
        ...
        gsapWithCSS.from(".first-screen-about__main-image", {
            y: "110%",
            x: 200,
            duration: 5,
            delay: 2.5,
        ...
        gsapWithCSS.from(".first-screen-about__background", {
            scale: 3,
        ...
        gsapWithCSS.from(".first-screen-about__decor-1", {
            right: -1e3,
            y: "-100%",
            duration: 7,
            delay: 1,
        ...
        gsapWithCSS.from(".first-screen-about__decor-2", {
            y: 1500,
            duration: 7,
            delay: 1,
            ease: "power4.out"
        ...
        gsapWithCSS.from(".first-screen-about__decor-3", {
            top: "15%",
            right: "30%",
            width: 70,
            duration: 7,
