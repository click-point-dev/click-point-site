...
*/
        ...
        class JustValidate {
            ...
            validateHandler(ev, forceRevalidation = false) {
                ...
                return this.validate(forceRevalidation).finally((() => {
                    ...
                    if (this.isValid) (_a = this.onSuccessCallback) == null ? void 0 : _a.call(this, ev); else (_b = this.onFailCallback) == null ? void 0 : _b.call(this, this.getCompatibleFields(), this.groupFields);
                }));
            }
            setForm(form) {
                this.form = form;
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            ...
            if (mainLens) gsapWithCSS.from(mainLens, {
                top: "52%",
                left: "64%",
                rotate: -90,
                duration: 4,
            ...
            if (formDecorTop) gsapWithCSS.from(formDecorTop, {
                scrollTrigger: {
            ...
            if (formDecorMiddle) gsapWithCSS.from(formDecorMiddle, {
                scrollTrigger: {
                    trigger: ".main-form__image",
                    toggleActions: "restart none none none"
                },
            ...
            if (formDecorBottom) gsapWithCSS.from(formDecorBottom, {
                scrollTrigger: {
                    trigger: ".main-form__image",
                    toggleActions: "restart none none none"
                },
            ...
            if (formLens) gsapWithCSS.from(formLens, {
                scrollTrigger: {
                    trigger: ".main-form__image",
                    toggleActions: "restart none none none"
                },
            ...
            if (image404) {
                gsapWithCSS.set(image404, {
                    visibility: "visible"
                });
                gsapWithCSS.to("#headStripe", {
                    y: .5,
                    rotation: 1,
                    yoyo: true,
                    repeat: -1,
                ...
                gsapWithCSS.fromTo("#starsSmall g", {
                    scale: 0,
                    transformOrigin: "50% 50%"
                }, {
                    scale: 1,
                ...
                gsapWithCSS.to("#circlesSmall circle", {
                    y: -4,
                    yoyo: true,
                    duration: 1,
                    ease: "sine.inOut",
                ...
                gsapWithCSS.to("#circlesBig circle", {
                    y: -2,
                    yoyo: true,
                    duration: 1,
                    ease: "sine.inOut",
                ...
                gsapWithCSS.set("#glassShine", {
                    x: -68
                });
                gsapWithCSS.to("#glassShine", {
                    x: 80,
                    duration: 2,
                    rotation: -30,
                    ease: "expo.inOut",
            ...
            if (forms.length) Array.from(forms).forEach((form => {
                ...
                if (telInput) inputMask.mask(telInput);
                ...
                if (filesInput) filesInput.addEventListener("change", (event => {
            ...
            function validateForm(form, validate, telInput) {
                ...
                if (form.phone) validate.addField("#phone", [ {
                    rule: "required",
                    ...
                    validator: function() {
                        let phone;
                        if (telInput.inputmask) phone = telInput.inputmask.unmaskedvalue();
                        return Number(phone) && phone.length === 10 ? true : false;
                    },
                    errorMessage: "Введите 10 цифр"
                } ]);
                if (form["file[]"]) validate.addField("#filesInput", [ {
                    rule: "files",
            ...
            function mountFilesList(files, placeholder) {
                ...
                if (files && !isOverSize && files.length <= 3) paintList(files, placeholder);
                return files;
            }
            function paintList(files, placeholder) {
                files.forEach((file => {
                    placeholder.insertAdjacentHTML("beforeend", `\t<div class="input-file__btn">\n\t\t\t\t<span class="_icon-trash" id="deleteFileButton">${file.name}</span>\n\t\t\t\t</div>\n\t\t\t\t`);
                }));
            }
            async function submitForm(form, filesList = []) {
                ...
                try {
                    ...
                    if (res.status !== 200) throw new Error(`❌ Что-то не так. Код ответа ${res.status}`);
                    modules_flsModules.popup.open("#popup-accept");
                } catch (error) {
                    console.error(error);
